function contar(){ //Chamo a função contar
    ...
    var pas = document.getElementById('txtpular') // "var pas" va acessar o input com o id "txtpular"
    ...
    if(ini.value.length == 0 || fi.value.length == 0 || pas.value.length == 0){ //Se o valor de ini for igual a 0 OU valor de fi for igual a 0 OU valor de pas for igual a 0...
